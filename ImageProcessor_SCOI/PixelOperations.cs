...
//    public static class PixelOperations
//    {
//        public static WriteableBitmap ApplyBlend(WriteableBitmap baseImage, WriteableBitmap overlay,
...
//                double oG = overlayPixels[i + 1];
//                double oR = overlayPixels[i + 2];
//                double oA = overlayPixels[i + 3] * opacity;
...
//                double oG = overlayPixels[i + 1];
//                double oR = overlayPixels[i + 2];
//                double oA = overlayPixels[i + 3] * effectiveOpacity; // Применяем прозрачность
